...
define('PG_REQUEST_URL', 'http://uat.pg.com/crm/jsp/paymentrequest');
define('PG_RESPONSE_URL', 'http://uat.pg.com/crm/jsp/response.jsp');
...
<head>
    ...
    <title>Bp Demo Merchant Checkout Page</title>
        ...
        <form action="" method="post">
            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="MERCHANTNAME" class="signuptextfield" value="Bp Demo" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_NAME" class="signuptextfield" value="PG DEMO" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>                   
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_EMAIL" class="signuptextfield" value="neeraj.kumar@pg.com" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
